...
namespace DavidVaupel\TennisTurnier\Tests\Unit\Domain\Model;
...
/**
 * Test case for class \DavidVaupel\TennisTurnier\Domain\Model\Spieler.
 *
...
class SpielerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \DavidVaupel\TennisTurnier\Domain\Model\Spieler
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \DavidVaupel\TennisTurnier\Domain\Model\Spieler();
	}
	 ...
	 * @test
	 */
	public function getStaerkeReturnsInitialValueForInteger() {
		$this->assertSame(
			0,
			$this->subject->getStaerke()
		);
	}
	 ...
	 * @test
	 */
	public function setStaerkeForIntegerSetsStaerke() {
		$this->subject->setStaerke(12);
	...
	public function setSpielmodusForObjectStorageContainingSpielmodusSetsSpielmodus() {
		$spielmodu = new \DavidVaupel\TennisTurnier\Domain\Model\Spielmodus();
