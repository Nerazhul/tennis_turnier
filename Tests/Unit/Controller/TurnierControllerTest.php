...
/**
 * Test case for class DavidVaupel\TennisTurnier\Controller\TurnierController.
 *
 */
class TurnierControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \DavidVaupel\TennisTurnier\Controller\TurnierController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('DavidVaupel\\TennisTurnier\\Controller\\TurnierController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllTurniersFromRepositoryAndAssignsThemToView() {
		...
		$turnierRepository = $this->getMock('DavidVaupel\\TennisTurnier\\Domain\\Repository\\TurnierRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenTurnierToView() {
		$turnier = new \DavidVaupel\TennisTurnier\Domain\Model\Turnier();
	...
	public function createActionAddsTheGivenTurnierToTurnierRepository() {
		...
		$turnierRepository = $this->getMock('DavidVaupel\\TennisTurnier\\Domain\\Repository\\TurnierRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenTurnierInTurnierRepository() {
		...
		$turnierRepository = $this->getMock('DavidVaupel\\TennisTurnier\\Domain\\Repository\\TurnierRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenTurnierFromTurnierRepository() {
		...
		$turnierRepository = $this->getMock('DavidVaupel\\TennisTurnier\\Domain\\Repository\\TurnierRepository', array('remove'), array(), '', FALSE);
