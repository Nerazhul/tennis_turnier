...
/**
 * Test case for class DavidVaupel\TennisTurnier\Controller\SpielmodusController.
 *
 */
class SpielmodusControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \DavidVaupel\TennisTurnier\Controller\SpielmodusController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('DavidVaupel\\TennisTurnier\\Controller\\SpielmodusController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function showActionAssignsTheGivenSpielmodusToView() {
		$spielmodus = new \DavidVaupel\TennisTurnier\Domain\Model\Spielmodus();
